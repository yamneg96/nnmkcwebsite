      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">NNMKC</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Sunday Sermons</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Youth Program</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Teen Program</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Nehemia Program</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Bible Study</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Community Outreach</a></li>
            </ul>
          </div>
        </div>
